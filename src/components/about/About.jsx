...
const About = () => {
  return (
    <div className="about d-flex pt-5 justify-content-center">
      <div className="container">
        ...
        <p>
          ...
          We understand the importance of staying organized and productive, which is why
            we've created a platform designed to streamline your workflow and enhance productivity.<br/><br/>
          ...
          in one convenient location. Say goodbye to scattered to-do lists and missed deadlines,
            and hello to a more organized and efficient way of managing your tasks.<br/><br/>
          ...
          assignments, or simply someone looking to stay organized in their personal life, Task Manager is here to help.<br/><br/>
